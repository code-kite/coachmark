package com.codebox.coachmark.configuration
...
import com.codebox.coachmark.views.CoachMarkSkipButton
import com.codebox.coachmark.views.CoachMarkOverlay
import com.codebox.coachmark.listener.SequenceListener
import java.util.*

class CoachMarkSequenceHandler(private val mContext: Context) {
    ...
    private var mSequenceListener: SequenceListener = object : SequenceListener {
        override fun onNextItem(coachMark: CoachMarkOverlay, coachMarkSequenceHandler: CoachMarkSequenceHandler) {
            super.onNextItem(coachMark, coachMarkSequenceHandler)
        }
    }
                ...
                if (mSequenceQueue.size > 0) {
                    ...
                    mSequenceItem?.apply {
                        ...
                        mSequenceListener?.let {
                            it.onNextItem(overlay, this@CoachMarkSequenceHandler)
                        }
                    }
                } else {
