...
/**
 * This class is used to design and build tool tip
 */
class CoachMarkInfoToolTip : View {
    ...
    class Builder(private val mContext: Context) {
        ...
        private var mToolTipWidth: Int = Utils.dpToPx(mContext, 16).roundToInt()
        private var mToolTipHeight: Int = Utils.dpToPx(mContext, 8).roundToInt()
